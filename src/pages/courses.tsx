    ...
    <div className="px-4">
      <div className="bg-gray-50 mt-10 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
        ...
        <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">
          Site-urile statice sunt acum folosite pentru a porni multe site-uri și
          devin baza pentru o varietate de instrumente care influențează atât
          designerii web, cât și dezvoltatorii web.
        </p>
        <Link
          href="#"
